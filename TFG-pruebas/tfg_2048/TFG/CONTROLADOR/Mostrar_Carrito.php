...
$ventas = Base_Operaciones::extraerDatos($id_usuario, 'id_usuario', 'compra_realizada');
...
foreach($ventas as $venta) {
    ...
    if (isset($producto[0])) {
        ...
        $html .= '<td id="cantidad" value="' . htmlspecialchars($venta['cantidad_c']) . '">' . htmlspecialchars($venta['cantidad_c']) . '</td>';
